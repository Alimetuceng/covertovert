...
Makefile Contents
	•	The Makefile includes well-defined rules for:
	•	send: Executes run.py send.
	•	receive: Executes run.py receive.
	•	compare: Validates logs between sender and receiver.
	•	documentation: Generates documentation using Sphinx.